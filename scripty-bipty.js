...
function draw() {
    ...
    if(frameNumber > 3000 && frameNumber < 99999){
        ...
        context.fillStyle = `rgba(45, 45, 255, ${opacity})`;
        context.textAlign = `center`;
        context.fillText("I love you so much Ishika, more than all the time and space in the universe can contain", canvas.width/2, canvas.height/2);
        opacity = opacity + 0.01;
    }
    ...
    if(frameNumber >= 3600 && frameNumber < 99999){
        ...
        context.textAlign = `center`;
        context.fillText("Happy Anniversary Baby <3", canvas.width/2, (canvas.height/2 + 100));
